...
export async function generateMetadata({
  ...
  return {
    ...
    twitter: { title: t("privacy.title"), description: t("privacy.description") },
  };
}

// Anchor ids stay in code (stable URL fragments); titles + content come from
// messages (privacyPage.sections), in this exact order.
